...
await axios.put(`http://localhost:3001/clients/${id}`, client); navigate('/clients', { replace: true });//retour à la liste
};
  return (
    <div>
<h1>Mettre à jour le client</h1> <form>
...
<button onClick={handleUpdate}>Mettre à jour</button> </form>
</div> );
};
